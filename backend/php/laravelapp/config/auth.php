...
return [
    ...
    // The expire time is the number of minutes that each reset token will be considered valid. This security feature keeps tokens short-lived so they have less time to be guessed. You may change this as needed.
    'passwords' => ['users' => ['provider' => 'users', 'table' => 'password_resets', 'expire' => 60, 'throttle' => 60]],

    // Password Confirmation Timeout: Here you may define the amount of seconds before a password confirmation times out and the user is prompted to re-enter their password via the confirmation screen. By default, the timeout lasts for three hours.
